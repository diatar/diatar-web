<div class="BETA_CONTAINER">
    ...
    <div class="BETA_CONTAINER_INT TABLE_ENTRY_EVEN">
        <div class="BETA_VERSION">
            <b>&nbsp 2023.09.10 - Linux betekintőablak javítása</b>
            <hr />
        </div>                                                
        <div class="BETA_LEFT">
            <div class="download_link expanded">                                                                                                        
                <a href="letoltes.php?letoltes=<?php echo urlencode('/beta/diatar64-b2');?>"><img style="border: none;"src="graphics/Diatar.ico"/>diatar64</a><br/>
            </div>
        </div>
        <div class="BETA_RIGHT">
            <div class="TABLE_TEXT expanded">
              <ul class="BETA_DOTTED">
                <li>
					Az operációs rendszerek eltérése miatt egy ideje a kis betekintőablak Linux alatt nem működött.
					Most sikerült olyan megoldást találni, amivel újra megnézhető a listák szövege az egér mozgatásával.
                </li>
              </ul>
            </div>                                                    
        </div>                                                
    ...
    <div class="BETA_CONTAINER_INT TABLE_ENTRY_ODD">
        <div class="BETA_VERSION">
            <b>&nbsp 2023.04.07 - Dia összeállítás exportja</b>
            <hr />
        </div>                                                
        <div class="BETA_LEFT">
            <div class="download_link expanded">                                                                                                        
                <a href="letoltes.php?letoltes=<?php echo urlencode('/beta/diatar-v12.7-b1.exe');?>"><img style="border: none;"src="graphics/Diatar.ico"/>diatar.exe</a><br/>
                <a href="letoltes.php?letoltes=<?php echo urlencode('/beta/diatar64-v12.7-b1.exe');?>"><img style="border: none;"src="graphics/Diatar.ico"/>diatar64.exe</a><br/>
            </div>
        </div>
        <div class="BETA_RIGHT">
            <div class="TABLE_TEXT expanded">
              <ul class="BETA_DOTTED">
                <li>
					Logikus kérés jött, hogy az énekrend összeállítást a kötetektől független módon,
					azaz minden diát "kézzel írt szövegként" lehessen elmenteni.
					Ehhez a [Mentés] gombba egy új, "Export" menüsor került.
                </li>
              </ul>
            </div>                                                    
        </div>                                                
